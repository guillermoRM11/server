...
public final class Parameters {
    ...
    public static final String BASE_PATH = "C:/Users/posti/OneDrive/Documentos/NetBeansProjects/fidelizados2-master/target/fidelizados";
    public static final String RELATIVE_PATH = "images/";
    public static final String SERVER_URL = "http://localhost:8082/fidelizados/";
